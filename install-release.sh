...
# Original source is located at github.com/pmoled/v2ray-core/release/install-release.sh
...
downloadV2Ray(){
    ...
    if [[ "${DIST_SRC}" == "jsdelivr" ]]; then
        ...
        DOWNLOAD_LINK="https://github.com/pmoled/v2ray-core/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    fi
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/pmoled/v2ray-core/releases/latest"
