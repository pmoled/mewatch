...
Download_ocserv(){
	...
	wget "https://raw.githubusercontent.com/pmoled/mewatch/master/lib/ocserv-${ocserv_ver}.tar.xz"
	...
	if [[ -e ${file} ]]; then
		mkdir "${conf_file}"
		wget --no-check-certificate -N -P "${conf_file}" "https://raw.githubusercontent.com/pmoled/mewatch/master/ocserv.conf"
